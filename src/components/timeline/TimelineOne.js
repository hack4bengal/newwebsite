  ...
  const data = [
    {
      ...
      descInDepth: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."
    },
    {
      time: '6th February',
      ...
      <div className='headers-timeline'>
        ...
        <div className='row-one'>
          <div className='headers'>
            <div className={`boxed ${active === 0 ? 'active' : ''}`} onClick={() => setActive(0)}>
          ...
          <div className='headers'>
            <div className={`boxed ${active === 1 ? 'active' : ''}`} onClick={() => setActive(1)}>
          ...
          <div className='headers'>
            <div className={`boxed ${active === 2 ? 'active' : ''}`} onClick={() => setActive(2)}>
          ...
          <div className='headers'>
            <div className={`boxed ${active === 3 ? 'active' : ''}`} onClick={() => setActive(3)}>
