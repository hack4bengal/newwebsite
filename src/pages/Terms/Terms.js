    ...
    <div>
      ...
      <div className="privacy">
        ...
        <p>
          ...
          related to it, still belong to Hack4Bengal.
        </p>
        <p>
          Hack4Bengal is committed to ensuring that the app is as useful and
        ...
        <p>
          The Hack4Bengal app stores and processes personal data that you have
          ...
          security features and it could mean that the Hack4Bengal app won’t
        ...
        <p>
          The link to the Terms and Conditions of third party services used by
          ...
          <p>
            <a href="https://razorpay.com/privacy/">Firebase Crashlytics</a>
          </p>
        </p>
        <p>
          You should be aware that there are certain things that Hack4Bengal
          ...
          Hack4Bengal cannot take responsibility for the app not working at full
        ...
        <p>
          Along the same lines, Hack4Bengal cannot always take responsibility
          ...
          on to avail the Service, Hack4Bengal cannot accept responsibility.
        </p>
        <p>
          With respect to Hack4Bengal’s responsibility for your use of the app,
          ...
          that we can make it available to you. Hack4Bengal accepts no liability
        ...
        <p>
          ...
          keep using the app. Hack4Bengal does not promise that it will always
        ...
        <p>
          ...
          this page. These terms and conditions are effective as of 2023-02-16
        </p>

        <h2>Contact Us</h2>
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at hack4bengal@gmail.com.
        </p>
      </div>
