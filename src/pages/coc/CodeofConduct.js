      ...
      <div className="hack4bengal__navbarTeam-container">
        ...
        <div className="privacy">
          <div className="privacy_2">
            ...
            <p>
              {" "}
              <span className="bold">Respect</span>: All participants must respect
              each other's opinions, beliefs, and values. Discriminatory language
              or behavior will not be tolerated. This includes, but is not limited
              to, sexism, racism, homophobia, and ableism.
            </p>
            <p>
              {" "}
            ...
            <p>
              {" "}
              <span className="bold">Privacy</span>: Participants must respect the
              privacy of others. Any confidential information shared during the
              hackathon must not be disclosed without the express consent of the
              person or team that shared it.
            </p>
            <p>
              {" "}
            ...
            <p>
              {" "}
              <span className="bold">Safety</span>: Participants should prioritize
              their safety and the safety of others throughout the hackathon. Any
              behavior that puts others in danger, including but not limited to
              physical violence or verbal threats, will not be tolerated.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              inclusive to all individuals regardless of gender, ethnicity, race,
              religion, age, or any other characteristic. All participants should
              work towards creating a safe and welcoming environment for everyone
              involved.
            </p>
            <p>
            ...
            <p>
              <span className="bold">Compliance with Laws</span>: All participants
              must comply with all applicable laws and regulations throughout the
              hackathon. Any illegal activities will not be tolerated.
            </p>
            <p>
              {" "}
              <span className="bold">Accountability</span>: All participants are
              accountable for their own actions and should take responsibility for
              any consequences that may arise from those actions.
            </p>
            ...
            <p>
              ...
              <p>
                ...
                Conduct, we encourage you to report it immediately. You can report
              ...
              <ul>
                <li style={{ paddingTop: "5px" }}>
                  ...
                  concerns with them. They will take appropriate action to address
                  the situation. The team of Hack4Bengal will be in proper
                  t-shirts with the logo of Hack4Bengal on it, along with a
                  lanyard and identity card.
                </li>
                <li style={{ paddingTop: "20px" }}>
                  <span className="bold">Email the Hack4Bengal team</span>: You
                  can send an email to the official Hack4Bengal email address
                  <a href="mailto: hack4bengal@gmail.com "> hack4bengal@gmail.com </a> and describe the incident in detail. We
                ...
                <li style={{ paddingTop: "20px" }}>
                  ...
                  <ul style={{ listStyleType: "circle", marginLeft: "60px" }}>
                    <li>Shubham Tribedi:   <a href="mailto:shubham@hack4bengal.tech"> shubham@hack4bengal.tech</a> </li>

                    <li>Sagnik Mitra: <a href="mailto:sagnik@hack4bengal.tech"> sagnik@hack4bengal.tech</a> </li>
