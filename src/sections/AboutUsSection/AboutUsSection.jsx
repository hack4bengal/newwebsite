  ...
  return (
    <>
      <motion.div
        ...
        id="aboutus"
      >
        {window.innerWidth < 768 ? <div className="h4b_about_main">
          <h1>About Us</h1>
          <hr />
          <div className="h4b_about_sub">
            ...
            <div className="h4b_about_textdiv">
              <div cn="h4b_about_textdiv_sub">
                ...
                growing from strength to strength and our aim is to go beyond
                the horizons and impact millions of tech talents by providing
                them with a platform to enhance their skills, collaborate and
                create. This time Hack4Bengal is back to leverage your expertise
                in the offline mode. See you there!
              </div>
            </div>
          </div>
        </div> : <div className="about_god">
