            ...
            <div className="h4b_about_more">
              <div className="h4b_about_more_element">
                <img
                  ...
                  alt=""
                />
                <p className="h4b_about_more_element_title">
                  Digitally Together
                </p>
                <p>
                  Though the Hackathon is offline this time, we will be
                  virtually connected with our community online
                </p>
              </div>

              <div className="h4b_about_more_element">
                <img
                  src="https://uploads-ssl.webflow.com/6327d6e9409aa34035883fac/6360a9327602010903fd7889_Innerstar-small.png"
                  alt=""
                />
                <p className="h4b_about_more_element_title">Exciting Rewards</p>
                <p>
                  Whatever be the contribution, there will be swags for
              ...
              <div className="h4b_about_more_element">
                <img
                  src="https://uploads-ssl.webflow.com/6327d6e9409aa34035883fac/6360a9359c0f366d66f8632e_Star-small.png"
                  alt=""
                />
                <p className="h4b_about_more_element_title">Most Awaited</p>
                <p>
                  What started as a team of 3, is now a community of 1500+
